...
- **In `.pdf` format**:  If you are viewing this document in your browser through a url, you can click on the top right icons of the document to download it.

- **Source code in GitHub**: You can also click on the top right icons of the document to access the [source code](https://github.com/Susana465/third_year_report).