...
This kind of self-reflection questions are useful for oneself to think about, but also for external people who are not involved with your project to understand what potential data hazards it might have.
...
You can also find a view of the poster in the GitHub repo where it lives, by clicking the image below:

[![Data Hazards Project - Case Study][a]][b]

[a]: poster_AIUK.png

[b]: https://github.com/Susana465/DH_Project_CaseStudy/blob/main/20230314_DH_casestudy.pdf
...
I have left the code which runs the bar chart below, so you can get a glimpse into how a Quarto book can work and embed runnning some python code and output results directly, all in one place. 
