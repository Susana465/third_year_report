...
[![Data Hazards Project - Case Study, to see GitHub repo, click on this figure](poster_AIUK.png){#fig-posterAIUK}](https://github.com/Susana465/DH_Project_CaseStudy)
...
Interestingly, not all labels were chosen as applicable to my project (@fig-barchart). Only 6 of the 11 current labels were chosen as relevant, with "difficult to understand" being the most prevalent one.  
